...
def test_upstream_metric_sum(river_network, input_field, flow_downstream, mv):
    output_field = ekh.upstream.sum(
        river_network, input_field, node_weights=None, mv=mv, accept_missing=True
    )
    print(output_field)
