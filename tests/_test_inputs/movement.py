...
move_downstream_skewness_1 = np.array(
    [np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, 0.0, np.nan, np.nan, np.nan, np.nan, 0.6309038567106233, 0.0, np.nan, np.nan, 0.40604028821330246, np.nan, np.nan, np.nan],
    dtype=float,
)
...
move_downstream_skewness_2 = np.array(
    [np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, 0.0, 0.0, np.nan, 0.0, np.nan, np.nan],
    dtype=float,
)
